...
riscv64-elf-gcc -L /usr/riscv32-elf/lib -I/usr/riscv32-elf/include/ -march=rv32i -mabi=ilp32 -nostartfiles -T linker/bl602/memmap.ld startup/bl602/* -o firmware.elf
